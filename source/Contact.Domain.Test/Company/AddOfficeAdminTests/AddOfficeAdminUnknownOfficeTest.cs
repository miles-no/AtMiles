...
namespace Contact.Domain.Test.Company.AddOfficeAdminTests
{
    ...
    public class AddOfficeAdminUnknownOfficeTest : EventSpecification<AddOfficeAdmin>
    {
        ...
        private const string Office1Id = "SVG1";
        private const string Office1Name = "Stavanger";

        private const string Office2Id = "SVG2";
            ...
            var events = new List<FakeStreamEvent>
                {
                    ...
                    new FakeStreamEvent(CompanyId, new EmployeeAdded(CompanyId, CompanyName, Office1Id, Office1Name, Admin1Id, NameService.GetName(Admin1FirstName , Admin1LastName), DateTime.UtcNow, new Person(Admin1Id, NameService.GetName(Admin1FirstName, Admin1LastName)),_correlationId)),
        ...
        public IEnumerable<FakeStreamEvent> GivenEmployee()
        {
            var events = new List<FakeStreamEvent>
                {
                    new FakeStreamEvent(Admin1Id, new EmployeeCreated(CompanyId, CompanyName, Office1Id, Office1Name, Admin1Id, Admin1FirstName, string.Empty, Admin1LastName, Admin1DateOfBirth, string.Empty,string.Empty,string.Empty,null,null, null,DateTime.UtcNow,new Person(Admin1Id, NameService.GetName(Admin1FirstName, Admin1LastName)), _correlationId)),
                    new FakeStreamEvent(Admin2Id, new EmployeeCreated(CompanyId, CompanyName, Office1Id, Office1Name, Admin2Id, Admin2FirstName, string.Empty, Admin2LastName, Admin2DateOfBirth, string.Empty,string.Empty,string.Empty,null,null, null,DateTime.UtcNow,new Person(Admin2Id, NameService.GetName(Admin2FirstName, Admin2LastName)), _correlationId)),
                };
            return events;
        }
        ...
        {
            var cmd = new AddOfficeAdmin(CompanyId, Office2Id, Admin2Id, DateTime.UtcNow, new Person(Admin1Id, NameService.GetName(Admin1FirstName, Admin1LastName)), _correlationId, 5);
            return cmd;
        }
