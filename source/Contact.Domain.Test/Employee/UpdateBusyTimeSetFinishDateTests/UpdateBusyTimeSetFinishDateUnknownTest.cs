...
{
    [TestFixture]
    public class UpdateBusyTimeSetFinishDateUnknownTest : EventSpecification<UpdateBusyTimeSetEndDate>
    {
        ...
        {
            return new UpdateBusyTimeSetEndDate(CompanyId, EmployeeId, BusyTimeId2, End2, DateTime.UtcNow, new Person(EmployeeId, NameService.GetName(EmployeeFirstName, EmployeeLastName)), _correlationId, Constants.IgnoreVersion);
        }
