    ...
    public class TerminateEmployeeAsOfficeAdminTest : EventSpecification<TerminateEmployee>
    {
        ...
        public override IEnumerable<Event> Expect()
        {
            var events = new List<Event>
                {
                    new EmployeeTerminated(CompanyId, CompanyName, OfficeId, OfficeName, EmployeeGlobalId, NameService.GetName(EmployeeFirstName, EmployeeLastName))
                                        .WithCorrelationId(_correlationId)
                                        .WithCreatedBy(new Person(AdminId, NameService.GetName(AdminFirstName, AdminLastName))),
                    new EmployeeRemoved(CompanyId, CompanyName, OfficeId, OfficeName, EmployeeGlobalId, NameService.GetName(EmployeeFirstName, EmployeeLastName))
                                        .WithCorrelationId(_correlationId)
                                        .WithCreatedBy(new Person(AdminId, NameService.GetName(AdminFirstName, AdminLastName))),
                };
            return events;
