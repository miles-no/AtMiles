...
{
    [TestFixture]
    public class AddBusyTimeExistingButNoConflictsTest : EventSpecification<AddBusyTime>
    {
        ...
        [Test]
        public void add_busy_time_existing_but_no_conflicts()
        {
            Setup();
        }
            ...
            var events = new List<FakeStreamEvent>
                {
                    ...
                    new FakeStreamEvent(EmployeeId, new BusyTimeAdded(CompanyId, CompanyName, OfficeId, OfficeName, EmployeeId, NameService.GetName(EmployeeFirstName, EmployeeLastName), BusyTimeId1, Start1, End1, Percentage1, Comment1, _timestamp, new Person(EmployeeId, NameService.GetName(EmployeeFirstName, EmployeeLastName)),"FIRST"))
                };
            return events;
        }
        ...
        public override IEnumerable<Event> Expect()
        {
            var events = new List<Event>
                {
                    new BusyTimeAdded(CompanyId, CompanyName, OfficeId, OfficeName, EmployeeId, NameService.GetName(EmployeeFirstName, EmployeeLastName), _busyTimeId2, Start2, End2, Percentage2, Comment2, _timestamp, new Person(EmployeeId, NameService.GetName(EmployeeFirstName, EmployeeLastName)),_correlationId)
                };
            return events;
        }
    }
