...
namespace no.miles.at.Backend.Domain.Test.Employee.SetPrivateAddressTests
{
    [TestFixture]
    [Category("BDD: Domain")]
    public class SetPrivateAddressUnknownCompanyTest : EventSpecification<SetPrivateAddress>
    {
        ...
        [Test]
        public async void set_private_address_unknown_company()
        {
        ...
        {
            return new SetPrivateAddress(CompanyId2, CompanyName, _privateAddress, DateTime.UtcNow, new Person(EmployeeId, NameService.GetName(EmployeeFirstName, EmployeeLastName)), _correlationId, Constants.IgnoreVersion);
        }
